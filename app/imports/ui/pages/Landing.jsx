  ...
  <Container id="landing-page" fluid className="py-3">
    <Row className="align-middle text-center">
      <Col xs={4} className="text-white">
        ...
        <h5>This address book enables any number of users to
          register and save their business contacts. You can only
      ...
      <Col xs={4} className="text-white">
        ...
        <h5>Each time you make contact with a contact, you can write a note that summarizes
